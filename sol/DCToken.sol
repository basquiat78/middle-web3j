...
contract DCToken is SafeMath, owned {

    string public name = "DCToken";        //  token name
    string public symbol = "DC";      //  token symbol
        ...
        public
    {
        ...
        emit Transfer(0x0, this, valueSale);

        balanceOf[addressVip] = valueVip;
        emit Transfer(0x0, addressVip, valueVip);

        balanceOf[addressFund] = valueFund;
        emit Transfer(0x0, addressFund, valueFund);

        balanceOf[addressPopular] = valuePopular;
        emit Transfer(0x0, addressPopular, valuePopular);

        balanceOf[addressTeam] = valueTeam;
        emit Transfer(0x0, addressTeam, valueTeam);
    }
        ...
        validStatue     
    {
        ...
        emit Buy(msg.sender, eth, quantity);
